        ...
        <div className="grid lg:grid-cols-12 gap-10 items-end">
          <div className="lg:col-span-7">
            ...
            <p className="mt-6 text-neutral-700 max-w-2xl leading-relaxed">
              Both lines are manufactured at SM Paint Industries{`'`} facility, share the same commitment to quality, and have been backed by the same family of paint makers since 1982. They differ only in the grade of pigments, binders, and the audience they serve.
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20" data-testid="brand-vespa">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            ...
            <h2 className="font-display text-6xl mt-5 mb-4" style={{ color: "var(--ink)" }}>VESPA</h2>
            <div className="font-serif-italic text-xl text-neutral-500 mb-6">Reliable. Workhorse coatings.</div>
          ...
          <div className="lg:col-span-7 space-y-3">
            ...
            <BrandRow name="Primer Surfacer" desc="Corrosion-resistant undercoat" />
            <BrandRow name="Aluminium Paint" desc="Industrial metallic protection" />
      ...
      <section style={{ background: "var(--ink)", color: "#fff" }} data-testid="brand-galleria">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            ...
            <h2 className="font-display text-6xl mt-5 mb-4">GALLERIA</h2>
            <div className="font-serif-italic text-xl text-white/70 mb-6">Premium. Engineered for refinement.</div>
          ...
          <div className="lg:col-span-7 space-y-3">
            <BrandRow dark name="Premium Enamel" desc="Mirror-like, fade-resistant pigments" />
            <BrandRow dark name="Premium Primer Surfacer" desc="Double-coverage premium primer" />
            <BrandRow dark name="Clear Varnish" desc="Crystal-clear, UV-stable varnish" />
            <BrandRow dark name="Hammertone Paint" desc="Decorative hammered metal finish" />
            <BrandRow dark name="Aluminium Paint" desc="Premium-grade metallic finish" />
          </div>
        </div>
      </section>
